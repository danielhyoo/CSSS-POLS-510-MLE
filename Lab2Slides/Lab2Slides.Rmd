...
7. Simulating predicted values and prediction intervals 
...
3. Find the MLEs using the $\textsf{optim()}$ function
...
# 6. Simulating predicted values and prediction intervals

## Scenario 1: Vary covariate 1

1. Create a data frame with a set of hypothetical scenarios for covariate 1 while keeping covariate 2 at its mean $\newline$

2. Simulate the predicted values and the prediction intervals using $\textsf{simcf}$ $\newline$

3. Plot the results $\newline$

Recall from lecture:

# 7. Simulating predicted values and prediction intervals - Scenario 1
\scriptsize
```{r}
...
# 7. Simulating predicted values and prediction intervals - Scenario 2
