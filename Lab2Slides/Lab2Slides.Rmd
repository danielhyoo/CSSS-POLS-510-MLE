...
# 3. Calculating predicted values - Scenario 1: Vary covariate 1
\scriptsize
```{r}
...
# 3. Calculating predicted values - Scenario 2: Vary covariate 2
\scriptsize
```{r}
# Calculate predicted values using predict()
...
# 5. Simulating predicted values and confidence intervals - Scenario 1: Vary covariate 1
\scriptsize
```{r}
...
# 5. Simulating predicted values and confidence intervals - Scenario 2: Vary covariate 2
